...
from actions.timer import set_timer, check_timers, cancel_timers
from actions.notes import take_note, list_notes, delete_note
...
def main():
    ui = ThenuxUI(BASE_DIR / "face.png", size=(900, 900))
